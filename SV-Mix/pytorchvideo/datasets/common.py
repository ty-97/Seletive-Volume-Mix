"""
From original at https://github.com/facebookresearch/detectron2/blob/main/detectron2/data/common.py
...
from pytorchvideo.utils.serialize import PicklableWrapper
