...
from pytorchvideo.utils.events import EventStorage, get_event_storage
...
class TrainerBase:
    ...
    def train(self, start_iter: int, max_iter: int):
        ...
        with EventStorage(start_iter, self.iters_per_epoch) as self.storage:
            try:
                self.before_train()
    ...
    def after_step(self):
        for h in self._hooks:
            h.after_step()
        self.mixup.momentum_update(self.model)
