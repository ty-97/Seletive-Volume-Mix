...
model_path = '/home/tanyi/.cache/torch/hub/checkpoints/'
model_path = {
...
class Uniformer(nn.Module):
    ...
    def get_pretrained_model(self, cfg):
        if cfg.UNIFORMER.PRETRAIN_NAME:
            ...
            print('\n\n\n\n',model_path[cfg.UNIFORMER.PRETRAIN_NAME],'\n\n\n\n')
    ...
    def forward(self, x, return_fea_map=False):
        if isinstance(x,list):
            x = x[0]

        x = self.forward_features(x) # b c t h w 
        
        feature_map = x.permute(0,2,3,4,1)
